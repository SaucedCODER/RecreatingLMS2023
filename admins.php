<?php
session_start();
$adminid = $_SESSION['userid'] = $_GET["userid"];
...
<nav>
    ...
    $sqll = "SELECT * FROM users where user_id = $adminid";
    $res = $conn->query($sqll);
    ...
    <a href="logout.php?userid=<?php echo $adminid ?>">Logout</a>
...
<div class="century">
    <main class="borrowtrans activ">
        ...
        <section class="search-reserve activ">
            ...
            <h2 class="cartno" style='padding:.4em;box-sizing:border-box;'> E-Cart////// <button class="show">show</button></h2>
            <div class="e-cart">
        ...
        <div class="managemodal deletemodalmangebook">
            <div class="modalofdel">
                <h3>Sure ka na ba?</h3>
                <button onclick="managebdel(event)" id="confirmationdelmb">CONFIRM</button>
...
<script>
    ...
    //xttp request forms 
    function xttpreq(filename, setparam = '') {
    ...
    function lendgetidconfirm(e) {
        ...
        xhr.send(`lendtouserid=${lendtoid}&userid=<?php echo $adminid ?>&confirm=ok`);
    ...
    function lendgetid(e) {
        ...
        xhr.send(`lendtouserid=${lendtoid}&userid=<?php echo $adminid ?>`);
    ...
    function lendonreservation(e) {
        ...
        xhr.onload = function() {
            if (xhr.status == 200) {
                ...
                // // let vall = checkresitems.dataset.status;
                // // if (vall) {
                // //     profilen.innerText = `Profile`;
                // //     editimg.src = 'usersprofileimg/profiledefault.jpg';
                // //     reservecontainer.textContent = "no datas yet";
                // // }
    ...
    //search in reservation facility for finding users reservations hahahahahahahahahahaha!!!   
